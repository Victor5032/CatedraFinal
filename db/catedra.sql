...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2021 a las 20:54:12
...
(1, 6, 'Funciones creación y edición listo', 10, '2021-03-23 23:21:43'),
(2, 6, 'Acceso al sistema y validación según usuario', 10, '2021-03-25 02:33:16'),
(3, 6, 'Creación de informes de ventas según requerimientos', 10, '2021-03-25 02:34:36'),
(4, 8, 'Conteo de datos listo para ser mostrado en informe', 10, '2021-03-26 05:36:21'),
(5, 7, 'Mantenimiento básico listo', 10, '2021-03-26 05:39:34'),
(6, 9, 'Paquete implementado', 10, '2021-03-26 19:25:06'),
(7, 10, 'Implementación de paquete para generar informes de finanzas', 10, '2021-03-26 23:34:33'),
(8, 10, 'Ya se muestran más detalles', 10, '2021-03-26 23:42:54');
...
INSERT INTO `caso` (`caso_id`, `codigo`, `solicitud_id`, `caso_descripcion`, `programador`, `fecha_limite`, `tester`, `fecha_registro`, `estado`) VALUES
(6, 'VENT20210323-789-21-789', 1, 'asdasdsasd', 19, '2021-03-26', 23, '2021-03-23 23:19:47', 5),
(7, 'LOGI20210323-842-21-547', 5, 'Nada adicional', 24, '2021-03-26', 26, '2021-03-24 21:13:41', 5),
(8, 'FFIJ20210318-982-21-760', 3, 'Debe ser hecho en Java', 24, '2021-03-31', 27, '2021-03-24 23:52:18', 1),
(9, 'FFIJ20210326-905-21-766', 6, 'Debe usar paquete de ministerio de haciendo ', 24, '2021-03-31', 23, '2021-03-26 19:23:49', 2),
(10, 'FINA20210326-873-21-359', 8, 'Generar factura mediante free code', 24, '2021-03-31', 27, '2021-03-26 23:29:24', 3);
...
(12, 'NEWW', 'Test de prueba', 20, '2021-05-11 03:23:18');
...
(2, 26, 6, '2021-03-24 19:49:54'),
(3, 27, 1, '2021-03-24 19:51:14');
...
INSERT INTO `observaciones` (`observacion_id`, `caso`, `observacion`, `fecha_registro`) VALUES
(1, 8, 'Se necesita más detalles en los informes', '2021-03-25 05:24:47'),
(2, 10, 'Necesitamos mas detalles al generar informe', '2021-03-26 23:37:38');
...
(1, 3, 1, 'Nuevo sistema de gestión de ventas', 'Se necesita un sistema que permita gestionar las ventas con las función de generar reportes de manera mensual', 'Ya se encuentra un sistema para facturación disponible', '2021-03-18 20:00:05', 2),
...
(3, 3, 2, 'Cambio a sistema de ventas actual', 'Se necesita poder generar reportes de manera semanal, así mismo generar una planilla', NULL, '2021-03-18 20:52:31', 1),
(4, 3, 2, 'Update de factura de telefonia fija', 'Nuevo formato para factura de telefonia fija', 'Porque sí', '2021-03-23 21:17:32', 2),
(5, 6, 1, 'Sistema para control de logistica', 'Nuevo sistema para control de logistica en el area', NULL, '2021-03-24 02:30:02', 1),
(6, 3, 2, 'Cambio en generacion de recibo final', 'Nuevas dimensiones para el formato de recibo de consumidor final', NULL, '2021-03-26 19:22:01', 1),
(8, 1, 1, 'Nuevo sistema de facturación fija', 'Nuesvo sistema para el area', NULL, '2021-03-26 23:14:51', 4);
...
(20, 2, 'carlos.perez', 'Carlos Armando', 'Perez', 'carlos@gmail.com', '456123', '2021-03-18 19:52:02', 1),
...
(24, 5, 'andrea.reales', 'Jocelyn Andrea', 'Reales Aguirre', 'andrea.reales15@gmail.com', 'andrea123456', '2021-03-24 19:42:46', 1),
(25, 5, 'edgar.torres', 'Edgar Alexander', 'Torres Borrayos', 'xander.torres@outlook.com', '123456', '2021-03-24 19:43:26', 1),
(26, 3, 'irvin.lozano', 'Irvin', 'Lozano', 'irvin.lozano@gmail.com', '123456', '2021-03-24 19:49:12', 1),
(27, 3, 'emerson.lopez', 'Emerson', 'López', 'emerson.lopez@outlook.com', 'emerson123456', '2021-03-24 19:50:46', 1),
(28, 5, 'abdiel.dubon', 'Abdiel', 'Dubon', 'abdiel@gmail.com', '123456', '2021-04-09 18:14:53', 1),
(39, 5, 'lucas.hernandez', 'Lucas', 'Hernandez Bernard', 'lucas.hernandez@gmail.com', '123456', '2021-04-16 04:13:32', 1),
(41, 5, 'jessica.gomez', 'Jessica', 'Goméz', 'jessi_gomez15@live.com', 'jessi123456', '2021-04-16 04:26:10', 1),
(42, 5, 'georgina.rodriguez', 'Georgina', 'Rodriguez', 'georgina@tahoo.com', 'cr71980', '2021-04-16 05:02:49', 1),
(44, 4, 'oskr.lovos', 'Oscar', 'Lovos', 'oskr.lovos78@gmail.com', '12345678', '2021-05-11 15:34:39', 1);
...
--
ALTER TABLE `bitacora`
  MODIFY `bitacora_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `caso`
--
ALTER TABLE `caso`
  MODIFY `caso_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `departamento`
--
ALTER TABLE `departamento`
  MODIFY `departamento_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `departamento_empleados`
--
ALTER TABLE `departamento_empleados`
  MODIFY `departamento_emple_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `estado_solicitud`
  MODIFY `estado_solicitud_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `observaciones`
  MODIFY `observacion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
