...
<%
    ...
    conex.setRs("SELECT * FROM departamento WHERE departamento_id = " + id + "");
            ...
            <div class="container">
                <div class="row">
                    <div class="jumbotron">
                        ...
                        <p class="lead">Proceda con precaución, si elimina este departamento esta no se podra recuperar!.</p>
                    </div>
                </div>
                <div class="row">
                    <form method="POST" action="eliminar_area.jsp" >
