...
<%
    ...
    if (nombre.equals("") || apellido.equals("") || usuario.equals("") || email.equals("") || password.equals("") || estado.equals("")) {
        ...
        route = "/admin/jefe_desarrollo/nuevo.jsp";
        tipo = "danger";
    } else {
        ...
        if (password.length() < 8) {
            ...
            route = "/admin/jefes_desarrollo.jsp";
%>
    ...
    <jsp:setProperty name="usuarios" property="tipo" value="4" />
    ...
    <body>
        ...
        <section class="py-4">
            <div class="container">
                <div class="row">
                    <div class="jumbotron">
                        <h1 class="display-4 py-3">Nuevo jefe de desarrollo ingresado.</h1>
                    </div>
                </div>
                <div class="row">
