...
<html lang="es" dir="ltr">
    <head>
        ...
        <title>Editar jefe desarrollo</title>
    ...
    <body>
        ...
        <section class="py-4">
            <div class="container">
                <h3 class="text-center">Editar jefe de desarrollo</h3>
                ...
                <% } %>
                <div class="py-3">
                    <a href="${pageContext.request.contextPath}/admin/jefes_desarrollo.jsp" class="btn btn-info">Regresar</a>
                </div>
                <%
                ...
                <div class="container-fluid">
                    <form action="${pageContext.request.contextPath}/admin/jefe_desarrollo/editar_jefe.jsp" method="POST">
