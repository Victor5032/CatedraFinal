...
<jsp:setProperty name="usuarios" property="usuario_id" value="<%= id %>" />
...
<html>
    <head>
        ...
        <title>Confirmacion de jefe eliminado</title>
    </head>
    <body>
        ...
        <section class="py-4">
            <div class="container">
                <div class="row">
                    <div class="jumbotron">
                        <h1 class="display-4">Jefe de área funcional eliminado.</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="alert alert-success" role="alert">
                        <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                            ...
                            <jsp:getProperty name="usuarios" property="borrarJefe" /> 
                            </p>
                    </div>
                </div>
                <div class="d-grid gap-2">
                    <a href="../jefes_areas.jsp" class="btn btn-info">
